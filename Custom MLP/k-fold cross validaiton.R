...
build_model <-function(){
  ...
  layer_conv_1d(filters = 4, kernel_size = 10, activation = "relu",input_shape = c(7808, 16),
                kernel_initializer = 'random_normal') %>%
  layer_max_pooling_1d(pool_size = 2) %>%
  
  layer_conv_1d(filters = 8, kernel_size = 10, activation = "relu",
  ...
  layer_conv_1d(filters = 1, kernel_size = 10, activation = "relu",
                kernel_regularizer =  regularizer_l2( l = 0.02),
                kernel_initializer = 'random_normal') %>%
